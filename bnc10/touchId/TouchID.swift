        ...
        if localAuthenticationContext.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: &authError) {
            localAuthenticationContext.evaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, localizedReason: reasonString) {
                ...
                if success {
                    ...
                    onError(error._code, TouchID.evaluateAuthenticationPolicyMessageForLA(errorCode: error._code))
                    print(TouchID.evaluateAuthenticationPolicyMessageForLA(errorCode: error._code))
            ...
            onError(error.code, TouchID.evaluateAuthenticationPolicyMessageForLA(errorCode: error.code))
            print(TouchID.evaluateAuthenticationPolicyMessageForLA(errorCode: error.code))
        }
    }
